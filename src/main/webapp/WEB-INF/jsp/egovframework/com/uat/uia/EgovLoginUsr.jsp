...
// 	}
    ...
    // 일반회원
    if (userSe == "GNR") { 
//         document.loginForm.action="<c:url value='/uss/umt/mber/EgovMberInsertView.do'/>";
...
function fnInit() {
    ...
    **************************** */
    ...
    <c:if test="${not empty fn:trim(message) and  message ne ''}"> 
    alert("${message}");    
    </c:if>
...
<!-- 일반로그인 -->
<div class="login_form" style="width: 300px;margin: 0 auto;padding-top: 155px;">  
	<form name="loginForm" id="loginForm" action="<c:url value='/uat/uia/actionLogin.do'/>" method="post">
	<input type="hidden" id="message" name="message" value="<c:out value='${message}'/>">
	
	<fieldset>
		<img style="width: 300px;height: 100px;"  src="<c:url value='/images/munhwa/logo.png'/>" style="margin:30px 0 0px 60px" alt="login title image"  title="login title image">
		<div class="login_type" style="text-align: center;">
			<ul id="ulLoginType">
...
<%-- 				<li><a href="javascript:fnLoginTypeSelect('typeEnt');" id="typeEnt" title=""><spring:message code="comUatUia.loginForm.ENT"/></a></li> <!-- 기업 --> --%>
		...
		<div class="login_input">
			<ul>
				...
				<li style="width: 195px;margin: 0 auto;"> 
					<ul class="btn_idpw" >
