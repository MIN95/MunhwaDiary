...
<!-- 상단타이틀 -->
<form:form commandName="qnaVO" action="${pageContext.request.contextPath}/uss/olh/qna/updateQna.do" method="post" onSubmit="fn_egov_updt_qna(document.forms[0]); return false;">  
<div class="wTableFrm">
	...
	<tbody>
		...
		<tr>
			...
			<td class="left" colspan="3">
			    <form:input path="wrterNm" title="${title} ${inputTxt}" size="70" maxlength="70" style="pointer-events: none;"/>
		...
		<tr>
			...
			<td class="nopd" colspan="3">
				<form:textarea path="qestnCn" title="${title} ${inputTxt}" cols="300" rows="20" style="height: 355px;"/>   
	...
	<!-- 하단 버튼 -->
	<div class="btn" style="width:89px;">
