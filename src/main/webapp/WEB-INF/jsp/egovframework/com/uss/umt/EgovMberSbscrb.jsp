...
<%--                <form:input path="moblphonNo" id="moblphonNo" title="${title} ${inputTxt}" cssClass="txaIpUmt" size="20" maxlength="15" /> --%>
					<form:input path="moblphonNo01" id="moblphonNo01" title="${title} ${inputTxt}" cssClass="txaIpUmt" size="5" maxlength="4" style="width:40px;"/>
                  -  <form:input path="moblphonNo02" id="moblphonNo02" cssClass="txaIpUmt" size="5" maxlength="4" style="width:40px;"/>
                  -  <form:input path="moblphonNo03" id="moblphonNo03" cssClass="txaIpUmt" size="5" maxlength="4" style="width:40px;"/>
                    <div><form:errors path="moblphonNo01" cssClass="error" /></div>
                    <div><form:errors path="moblphonNo02" cssClass="error" /></div>
                    <div><form:errors path="moblphonNo03" cssClass="error" /></div>
...
<!-- 			</td> -->
<!-- 		</tr> -->
		<input type="hidden" name="mberSttus" value="P" />
	</tbody>
	</table>
